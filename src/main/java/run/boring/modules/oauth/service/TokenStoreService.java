package run.boring.modules.oauth.service;

import run.boring.base.ModuleService;
import run.boring.modules.oauth.dao.TokenStoreDao;
import run.boring.modules.oauth.entity.TokenStoreEntity;
import run.boring.modules.oauth.store.ValueType;
...
public class TokenStoreService extends ModuleService<TokenStoreDao, TokenStoreEntity> {
    ...
    public TokenStoreEntity saveOrUpdate(TokenStoreEntity tokenStoreEntity, String accessToken, String refreshToken) {
        return saveOrUpdate(tokenStoreEntity, accessToken, refreshToken, ClientDetailsService.ACCESS_TOKEN_DEFAULT_EXPIRED_IN, ClientDetailsService.REFRESH_TOKEN_DEFAULT_EXPIRED_IN);
    }

    public TokenStoreEntity saveOrUpdate(SysUserEntity sysUserEntity, String accessToken, String refreshToken, String authCode) {
        return saveOrUpdate(sysUserEntity, accessToken, refreshToken, authCode, ClientDetailsService.ACCESS_TOKEN_DEFAULT_EXPIRED_IN, ClientDetailsService.REFRESH_TOKEN_DEFAULT_EXPIRED_IN);
    }
