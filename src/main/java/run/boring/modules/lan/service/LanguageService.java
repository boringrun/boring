package run.boring.modules.lan.service;
...
import run.boring.modules.lan.service.gen.LanguageServiceGen;
...
import run.boring.core.table.utils.HumpConvert;
...
public class LanguageService extends LanguageServiceGen implements LoadFactory.Load, LoadFactory.Must, LoopJob.TenMinute, CategoryHandler {
    ...
    public String[][] getConfigItems() {
        String[][] mapping = new String[][]{
                {MULTIPLE_LANGUAGE_CONFIG_KEY, getLanguageMetadataJson(), "0", "多语言配置信息", config, SysConfigService.array_type},
                {DEFAULT_USER_LANGUAGE, "zh_CN", "1", "用户缺省语言设置", config, SysConfigService.selection_type, "zh_CN,en_US"},
        };
        return mapping;
    }
