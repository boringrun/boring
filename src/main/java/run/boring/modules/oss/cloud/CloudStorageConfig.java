...
import run.boring.core.validator.group.AliyunGroup;
import run.boring.core.validator.group.QcloudGroup;
import run.boring.core.validator.group.QiniuGroup;
...
import static run.boring.modules.sys.service.SysConfigService.*;

@ConfigParam(paramKey = SysConfigService.CLOUD_STORAGE_CONFIG_KEY, category = SysCategoryService.storage_config, name = category_lang_string + SysCategoryService.storage_config + "_name", description = category_lang_string + SysCategoryService.storage_config + "_description")
