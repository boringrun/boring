package run.boring.modules.gen.service;

import run.boring.modules.gen.entity.GenTypeEntity;
import run.boring.modules.gen.entity.GenTypeWrapper;
import run.boring.modules.gen.service.gen.GenTypeServiceGen;
...
public class GenTypeService extends GenTypeServiceGen {
    ...
    public void init() {
        String[][] mapping = new String[][]{
                {null, "mysql", "run.boring", "run.boring.modules", "sys", "系统管理", SysMenuService.getSystemManagementMenuKey(), "User", "henryxm@163.com", "sys",
