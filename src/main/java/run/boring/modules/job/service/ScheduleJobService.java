package run.boring.modules.job.service;

import run.boring.core.annotation.TaskAware;
import run.boring.modules.job.entity.ScheduleJobEntity;
import run.boring.modules.job.service.gen.ScheduleJobServiceGen;
import run.boring.modules.job.task.LoopJob;
import run.boring.modules.job.utils.ScheduleUtils;
...
public class ScheduleJobService extends ScheduleJobServiceGen implements InitFactory.Must, LoopJob.TenSecond {
    ...
    public String[][] menus() {
        ...
        String[][] menus = new String[][]{
                ...
                {"日志列表", NULL, "job:schedulejob:log", "2", NULL, "0", SysMenuService.getSystemMenuKey("JobScheduleLog"), menuKey, "sys_string_log_list"},
                {"立即执行", NULL, "job:schedulejob:run", "2", NULL, "0", SysMenuService.getSystemMenuKey("JobScheduleRun"), menuKey, "sys_string_immediate_execution"},
                {"暂停", NULL, "job:schedulejob:pause", "2", NULL, "0", SysMenuService.getSystemMenuKey("JobSchedulePause"), menuKey, "sys_string_suspend"},
                {"恢复", NULL, "job:schedulejob:resume", "2", NULL, "0", SysMenuService.getSystemMenuKey("JobScheduleResume"), menuKey, "sys_string_resume"},
        };
        return menus;
    }
