...
public class SysLogController {
     ...
     * @param singlePath  需要单独设置日志输出级别的类的全限定名（例:run.boring.modules.sys.controller.SysLogController）
     * @return
     */
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "singlePath",
                    value = "单独类路径:run.boring.modules.sys.controller.SysLogController",
                    required = false)})
    @ResponseBody
