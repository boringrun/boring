...
import run.boring.handler.config.FilterChainHandler;
import run.boring.modules.spm.filter.SpmFilter;
import run.boring.modules.sys.shiro.RedisShiroSessionDAO;
import run.boring.modules.sys.shiro.UserRealm;
...
public class ShiroConfig {
    ...
    public SessionManager sessionManager(RedisShiroSessionDAO redisShiroSessionDAO,
                                         @Value("${boring.redis.open}") boolean redisOpen,
                                         @Value("${boring.shiro.redis}") boolean shiroRedis) {
        ...
        cookie.setName("boringid");
        //如果开启redis缓存且boring.shiro.redis=true，则shiro session存到redis里
